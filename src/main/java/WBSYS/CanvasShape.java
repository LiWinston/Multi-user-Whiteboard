...
public class CanvasShape implements Serializable {
	...
	public CanvasShape(String shapeString, Color color, int x1, int x2, int y1, int y2, boolean fill, String username,
			int strokeInt) {
		this.shapeString = shapeString;
		this.color = color;
		this.x1 = x1;
	...
	public CanvasShape(String shapeString, Color color, int x1, int x2, int y1, int y2, String text, boolean fill,
			String username, int strokeInt) {
		this.shapeString = shapeString;
		this.color = color;
		this.x1 = x1;
		this.x2 = x2;
	...
	public String toString() {
		return "CanvasShape{" + "type='" + shapeString + '\'' + ", color=" + color + ", x1=" + x1 + ", x2=" + x2
				+ ", y1=" + y1 + ", y2=" + y2 + ", text='" + text + '\'' + ", fill=" + fill + ", username='" + username
				+ '\'' + ", points=" + points + ", strokeInt=" + strokeInt + '}';
	}
